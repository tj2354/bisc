...
if os_name == 'Windows':
    UTILS_DIR = 'c:/Users/kraus/Desktop/BISC_software'
    DATA_DIR = '.' 
else:
    UTILS_DIR ='/users/tjung/Measurement/BISC_Respin/Recording' 
    DATA_DIR = '/proj/bisc/measurements/recording/preprocess/troopa_20230919/pipeline_v2' 

# raw data directories
if os_name == 'Windows':
    RAW_DATA_DIR = '.'
    RAW_MOTION_DIR = f'{RAW_DATA_DIR}/motion_v3'
    RAW_REC_DIR = f'{RAW_DATA_DIR}/recording'
else:
    RAW_DATA_DIR = '/proj/bisc/measurements/recording/rawdata/troopa/troopa_20230919/'
    RAW_REC_DIR = f'{RAW_DATA_DIR}/troopa_bisc_recording_20230919'
    RAW_MOTION_DIR = f'{RAW_DATA_DIR}/troopa_motion_20230919/motion_v3'

# processed data directories
MOTION_DIR          = f'{DATA_DIR}/motion_v3_postprocess'
REC_DIR             = f'{DATA_DIR}/recording_postprocess_v3'

BAND_MU_SIGMA_DIR   = f'{REC_DIR}/7_channel_band_mu_sigma'
